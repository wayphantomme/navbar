...
- Centered logo and text alignment
- Smooth hover transitions
- Simple, clean, and reusable code structure
- Ready for integration with any landing page or web app
...
1. Clone this repository:
   ```bash
   git clone https://github.com/wayphantomme/navbar.git
````
...
* Add dark/light mode
* Animate logo and link transitions
* Convert to React component for dynamic sites
